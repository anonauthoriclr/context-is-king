...
"$V/bin/python" -u geom_tree.py google/gemma-4-31B-it --nscr 6 --qset anc > results/geometry/log_treectrl_31b.txt 2>&1; gf
"$V/bin/python" -u geom_tree.py Qwen/Qwen3.5-27B --nscr 6 --qset anc > results/geometry/log_treectrl_qwen.txt 2>&1
echo DONE_TREECTRL
